export const dict = {
  ...
  "prompt.dropzone.label": "Drop files here to attach",
  ...
  "prompt.toast.pasteUnsupported.description": "This item can't be attached here.",
  "prompt.toast.fileTooLarge.title": "File too large",
  "prompt.toast.fileTooLarge.description": "Files over 25 MB can't be attached. Upload it to the server instead.",
